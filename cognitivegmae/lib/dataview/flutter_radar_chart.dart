...
class _RadarChartState extends State<RadarChart>
  ...
  double fraction = 0;
  late Animation<double> animation;             //加入動畫
  late AnimationController animationController;  //動畫時間
...
class RadarChartPainter extends CustomPainter {    //建立圖形
  final List<int> ticks;
  final List<String> features;
  final List<List<int>> data;
  final bool reverseAxis;
