...
class PerceptionEXI extends StatelessWidget {
  @override
...
class EXModelpageState extends State<EXModelpage>{
  ...
  Widget build(BuildContext context) {
    ...
    String essay_1 = '空間知覺測驗\n主要測驗您對於物體或圖形的組成及概念\n\n接下來您將進行此測驗...';
    String essay_2 = '如上圖所示\n\n上層物體是由下層哪「三」個物件?\n請選出最有可能的三個選項\n(沒有計時)';

    final entBtn = ElevatedButton(
      child: Text('確定', style: TextStyle(fontSize: 25,color: Colors.black)),
    ...
    final startBtn = ElevatedButton(
      child: Text('開始作答', style: TextStyle(fontSize: 25,color: Colors.black)),
      style: ButtonStyle(backgroundColor: MaterialStateProperty.all(Color(0xFFE8E8E8))),
      onPressed: (){
        Navigator.pushNamed(context, 'perceptionPage');//下一頁
      },
    );
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              image: DecorationImage(
                fit: BoxFit.cover,
                image: AssetImage('assets/perception/game_I.gif'),
              ),
            ),
          ),
        ),
